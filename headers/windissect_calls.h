...
static constexpr wchar_t module_name[25] = {0x0050, 0x0068, 0x006F, 0x0074, 0x006F, 0x004D, 0x0065, 0x0074, 0x0061, 0x0064, 0x0061, 0x0074, 0x0061, 0x0048, 0x0061, 0x006E, 0x0064, 0x006C, 0x0065, 0x0072, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 257996614U || rva >= image_size) return nullptr;
return base + rva;
}
