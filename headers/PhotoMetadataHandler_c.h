// Flat C exports observed in PhotoMetadataHandler.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef PHOTOMETADATAHANDLER_C_H
#define PHOTOMETADATAHANDLER_C_H
...
#endif
#endif // PHOTOMETADATAHANDLER_C_H
