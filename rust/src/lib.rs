//! Windissect-generated Rust FFI bindings for PhotoMetadataHandler.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "C9962A5F4DBAC6633D3DD9C92D3A1E78";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 257996614;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 25] = [80, 104, 111, 116, 111, 77, 101, 116, 97, 100, 97, 116, 97, 72, 97, 110, 100, 108, 101, 114, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 257996614 { return 0; }
